...
<head>
  ...
  <title><?php echo get_setting('nama_aplikasi') ?></title>
...
<div class="wrapper">
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; <?php echo date('Y') ?> <a href="#">Klinik Dokter</a>.</strong> All rights
    reserved.
  </footer>
...
<script type="text/javascript">
    tinymce.init({
        ...
        images_upload_url: 'https://demo.suryasentosa.com/app/tinymce_upload',
        images_upload_base_path: 'https://demo.suryasentosa.com/',
